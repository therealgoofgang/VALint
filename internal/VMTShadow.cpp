...
VMTShadowing::VMTShadowing(void* object)
{
	...
	this->m_ptr_object_fake_vtable = new uintptr_t[m_object_vtable_size];
...
size_t VMTShadowing::get_function_count()
{
	...
	do {
		++methods;
	} while (*(uintptr_t*)((uintptr_t)this->m_ptr_object_vtable + (methods * 0x8))); //vtable da ki methodlar?null olana kadar looplad?ve method say�s�n?buldu
